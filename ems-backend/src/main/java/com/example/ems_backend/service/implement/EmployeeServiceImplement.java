package com.example.ems_backend.service.implement;
...
public class EmployeeServiceImplement implements EmployeeService {
    ...
    public EmployeeDto createEmployee(EmployeeDto employeeDto) {
        ...
        return EmployeeMapper.mapToEmployeeDto(newSavedEmployee);
    }
    ...
    public EmployeeDto updateEmployee(Long employeeId, EmployeeDto updatedEmployee) {
        Employee employee = employeeRepository.findById(employeeId).orElseThrow(() ->  new
                ResourceNotFoundException("Employee doesn't exist with the given id: + employeeID"));
